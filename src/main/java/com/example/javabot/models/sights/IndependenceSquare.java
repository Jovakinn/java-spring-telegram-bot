...
public class IndependenceSquare {
    public static SendMessage getIndependenceResponse(Message message) {
        ...
        text += "https://en.wikipedia.org/wiki/Maidan_Nezalezhnosti\n";
        text += "https://www.kiev.info/culture/independence_square.htm\n";
